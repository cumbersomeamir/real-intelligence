...
/**
 * Renders ReportCard with loading/error/empty support.
 * @param {Object} props - Component props.
 * @param {boolean} [props.loading] - Loading state.
 * @param {string|null} [props.error] - Error message.
 * @param {Array<any>} [props.items] - Data items.
 * @returns {JSX.Element} ReportCard block.
 */
export default function ReportCard({ loading = false, error = null, items = [] }) {
  if (loading) {
    return (
      <Card>
