...
/**
 * Renders PropertyDetail with loading/error/empty support.
 * @param {Object} props - Component props.
 * @param {boolean} [props.loading] - Loading state.
 * @param {string|null} [props.error] - Error message.
 * @param {Array<any>} [props.items] - Data items.
 * @returns {JSX.Element} PropertyDetail block.
 */
export default function PropertyDetail({ loading = false, error = null, items = [] }) {
  if (loading) {
    return (
      <Card>
  ...
  return (
    <Card>
      <h3 className="text-lg font-semibold">PropertyDetail</h3>
